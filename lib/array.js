Object.defineProperties(Array.prototype, {
  ...
  sum: { get: function() { return (func ? this.map(func) : this).reduce((sum, x) => sum + x); }, configurable: true, enumerable: false },
...
Array.prototype.sum = function(func) {
  return (func ? this.map(func) : this).reduce((sum, x) => sum + x);
};
