// To Do
// Change over to Temporal and add Time and DateTime classes
...
for (const unit of ["day", "week", "month", "quarter", "year"]) {
  defineProperties(Date.prototype, {
    ...
    [`at_beginning_of_${unit}`]: function () {
      return this[`beginning_of_${unit}`];
    },
    [`at_end_of_${unit}`]: function () {
...
defineProperties(Date.prototype, {
  ...
  change: function ({ year, month, day, hour, minute, second, ms } = {}) {
    return new Date(
      Date.UTC(
